...
numbers = [-1, 0, 0, 1, 2]
n = 0
while n < len(numbers) and numbers[n] <= 0:
    n = n + 1
print(f"First positive - {numbers[n]}")
if n == len(numbers):
    print("відсутні додатні елементи")
print("\n===========================================================")
...
x = a.index(max(a))
a[q], a[x] = a[x], a[q]
print(f"Перестановка min і max: {a}")  # ' '.join([str(i) for i in a])
print("\n===========================================================")
